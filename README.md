# Overview
This fork is aimed to automate the 2FA authorization.

For 2FA automatization u need:
1. Share QR code from the Google authentificator and save qr code to png file.
2. Extract otp secret from your QR code, using [extract_otp_secrets](https://github.com/scito/extract_otp_secrets)
3. Define your secret in the config.ini

# Preparation
1. Clone the IBC repo
```
git clone https://github.com/format37/IBC.git
```
2. Copy files from resources directory to c:\IBC\
3. Define in the config.ini:
* IbLoginId
* IbPassword
* TradingMode
* totp_secret

4. Update the TWS_MAJOR_VRSN in the following files:
* StartTWS.bat
* StartGateway.bat
...
2. Download Apache Ant and extract to
https://ant.apache.org/bindownload.cgi

```
$env:IBC_BIN = "C:\Jts"
java -cp "C:\apache-ant\lib\ant-launcher.jar" org.apache.tools.ant.launch.Launcher -buildfile C:\Users\alex\projects\IBC\build.xml
cp C:\Users\alex\projects\IBC\resources\IBC.jar C:\IBC
```
